...
class hab_Hide_Admin_Bar_Based_On_User_Roles {
	...
	private function define_admin_hooks() {
		...
		if( isset($_GET['page']) && $_GET['page'] == 'hide-admin-bar-settings' ){
			$this->loader->add_action( 'admin_footer', $plugin_admin, 'hab_admin_footer_scripts' );
		}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'login_enqueue_scripts', $plugin_public, 'hab_change_admin_login_logo' );
